...
-- ----------------------------------------------------- 
 -- INSERT TRIGGER ON bundle.request_type 
-- ----------------------------------------------------- 
DROP TRIGGER IF EXISTS bundle.tr_request_type_insert ; 

DELIMITER | 

CREATE 
DEFINER='db_dev'
TRIGGER bundle.tr_request_type_insert 
BEFORE INSERT ON bundle.request_type 
...
-- ----------------------------------------------------- 
 -- UPDATE TRIGGER ON bundle.request_type
-- ----------------------------------------------------- 
DROP TRIGGER IF EXISTS bundle.tr_request_type_update ; 

DELIMITER | 

CREATE 
DEFINER='db_dev'
TRIGGER bundle.tr_request_type_update 
BEFORE UPDATE ON bundle.request_type
...
DROP TRIGGER IF EXISTS bundle.tr_request_type_delete; 

DELIMITER | 

CREATE
DEFINER='db_dev'
TRIGGER bundle.tr_request_type_delete
BEFORE DELETE ON bundle.request_type
FOR EACH ROW
BEGIN 
