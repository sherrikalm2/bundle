...
-- ----------------------------------------------------- 
 -- INSERT TRIGGER ON bundle.shape 
-- ----------------------------------------------------- 
DROP TRIGGER IF EXISTS bundle.tr_shape_insert ; 

DELIMITER | 

CREATE 
DEFINER = 'db_dev'
TRIGGER bundle.tr_shape_insert 
BEFORE INSERT ON bundle.shape 
...
-- ----------------------------------------------------- 
 -- UPDATE TRIGGER ON bundle.shape
-- ----------------------------------------------------- 
DROP TRIGGER IF EXISTS bundle.tr_shape_update ; 

DELIMITER | 

CREATE 
DEFINER = 'db_dev'
TRIGGER bundle.tr_shape_update 
BEFORE UPDATE ON bundle.shape
...
DROP TRIGGER IF EXISTS bundle.tr_shape_delete; 

DELIMITER | 

CREATE
DEFINER = 'db_dev'
TRIGGER bundle.tr_shape_delete
BEFORE DELETE ON bundle.shape
FOR EACH ROW
BEGIN 
