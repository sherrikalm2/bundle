...
-- ----------------------------------------------------- 
 -- INSERT TRIGGER ON bundle.bundle_shape 
-- ----------------------------------------------------- 
DROP TRIGGER IF EXISTS bundle.tr_bundle_shape_insert ; 

DELIMITER | 

CREATE 
DEFINER = 'db_dev'
TRIGGER bundle.tr_bundle_shape_insert 
BEFORE INSERT ON bundle.bundle_shape 
...
-- ----------------------------------------------------- 
 -- UPDATE TRIGGER ON bundle.bundle_shape
-- ----------------------------------------------------- 
DROP TRIGGER IF EXISTS bundle.tr_bundle_shape_update ; 

DELIMITER | 

CREATE 
DEFINER = 'db_dev'
TRIGGER bundle.tr_bundle_shape_update 
BEFORE UPDATE ON bundle.bundle_shape
...
DROP TRIGGER IF EXISTS bundle.tr_bundle_shape_delete; 

DELIMITER | 

CREATE
DEFINER = 'db_dev'
TRIGGER bundle.tr_bundle_shape_delete
BEFORE DELETE ON bundle.bundle_shape
FOR EACH ROW
BEGIN 
